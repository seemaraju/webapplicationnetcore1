...
(function () {
    ...
    angular.module('xlsx-model', []).directive('xlsxModel', [
        '$parse',
        function ($parse) {
            return {
                restrict: 'A',
                link: function (scope, el, attrs) {
                    ...
                    el.bind('change', function () {
                        if (attrs.multiple) {
                            ...
                            angular.forEach(el[0].files, function (f) {
                                ...
                                reader.onload = function (file) {
                                    ...
                                    master[f.name] = {};
                                    angular.forEach(wb.SheetNames, function (
                                        name
                                    ) {
                                        master[f.name][
                                            name
